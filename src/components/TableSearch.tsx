    ...
    return (
        <>
            <Form
                ...
                form={form}
            >
                <Row className="flex flex-wrap items-center gap-3 sm:gap-5">
                    <Form.Item className="w-full sm:w-80" label="文章标题" name="title">
                        <Input placeholder={'请输入文章标题'} />
                    </Form.Item>
                    <Form.Item className="w-full sm:w-72" label="分类" name="categoryId">
                        <Select placeholder={'请选择分类'} options={[
                            { label: '全部', value: '' },
                            ...categoryOptions
                        ]} />
                    </Form.Item>
                    <Form.Item className="w-full sm:w-72" label="状态" name="status">
